...
Licensor:             DataMoat contributors
...
To specify as the Change License the GPL Version 2.0 or any later version, or a license that is
...
Version 2.0 or a later version. Licensor may specify additional Change Licenses without limitation.

To either: (a) specify an additional grant of rights to use that does not impose any additional
restriction on the right granted in this License, as the Additional Use Grant; or (b) insert the
text "None" to specify a Change Date. Not to modify this License in any other way.
